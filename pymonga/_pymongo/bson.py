...
from pymonga._pymongo.errors import InvalidBSON, InvalidDocument
from pymonga._pymongo.errors import InvalidName, InvalidStringData

try:
    from pymonga._pymongo import _cbson
    _use_c = True
except ImportError:
    _use_c = False
